...
import com.shopify.api.contracts.order.LineItem;
import com.shopify.api.contracts.order.SubtotalSet;
import com.shopify.api.contracts.order.TotalTaxSet;
...
public class RefundLineItem implements Serializable {
	...
	private final static long serialVersionUID = 8286427840702599168L;
	 ...
	 * @param subtotalSet
	 */
	public RefundLineItem(long id, long quantity, long lineItemId, long locationId, String restockType, long subtotal,
			long totalTax, SubtotalSet subtotalSet, TotalTaxSet totalTaxSet, LineItem lineItem) {
		super();
		this.id = id;
	...
	public RefundLineItem withSubtotal(long subtotal) {
		this.subtotal = subtotal;
		return this;
	}
	...
	public RefundLineItem withTotalTax(long totalTax) {
		this.totalTax = totalTax;
		return this;
	}

...
import com.shopify.api.contracts.order.RefundLineItem;
...
public class Refund implements Serializable {
	...
	private List<com.shopify.api.contracts.orders.refund.Transaction> transactions = new ArrayList<com.shopify.api.contracts.orders.refund.Transaction>();
	@JsonProperty("order_adjustments")
	private List<Object> orderAdjustments = new ArrayList<Object>();
	@JsonIgnore
	private Map<String, Object> additionalProperties = new HashMap<String, Object>();
	private final static long serialVersionUID = 8363972215134616993L;
	 ...
	 * @param orderId
	 */
	public Refund(long id, long orderId, String createdAt, String note, Object userId, String processedAt,
			boolean restock, String adminGraphqlApiId, List<RefundLineItem> refundLineItems,
			List<com.shopify.api.contracts.orders.refund.Transaction> transactions, List<Object> orderAdjustments) {
		super();
		this.id = id;
	...
	public Refund withUserId(Object userId) {
		this.userId = userId;
		return this;
	}
	...
	@JsonProperty("transactions")
	public List<com.shopify.api.contracts.orders.refund.Transaction> getTransactions() {
		return transactions;
	}

	@JsonProperty("transactions")
	public void setTransactions(List<com.shopify.api.contracts.orders.refund.Transaction> transactions) {
		this.transactions = transactions;
	}

	public Refund withTransactions(List<com.shopify.api.contracts.orders.refund.Transaction> transactions) {
		this.transactions = transactions;
		return this;
	}

...
public class PaymentDetails implements Serializable
{
    ...
    private final static long serialVersionUID = -4219499211163864528L;
     ...
     * @param cvvResultCode
     */
    public PaymentDetails(String creditCardBin, String avsResultCode, String cvvResultCode, String creditCardNumber, String creditCardCompany) {
        super();
    ...
    public PaymentDetails withCreditCardBin(String creditCardBin) {
        this.creditCardBin = creditCardBin;
        return this;
    }
    ...
    public PaymentDetails withAvsResultCode(String avsResultCode) {
        this.avsResultCode = avsResultCode;
        return this;
    }
    ...
    public PaymentDetails withCvvResultCode(String cvvResultCode) {
        this.cvvResultCode = cvvResultCode;
        return this;
    }

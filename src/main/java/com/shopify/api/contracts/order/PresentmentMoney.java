...
public class PresentmentMoney implements Serializable
{
    ...
    private final static long serialVersionUID = -5374083905129856127L;
     ...
     * @param currencyCode
     */
    public PresentmentMoney(String amount, String currencyCode) {
        super();
        this.amount = amount;
    ...
    public PresentmentMoney withAmount(String amount) {
        this.amount = amount;
        return this;
    }
    ...
    public PresentmentMoney withCurrencyCode(String currencyCode) {
        this.currencyCode = currencyCode;
        return this;
    }
    ...
    public PresentmentMoney withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PresentmentMoney) == false) {
            return false;
        }
        PresentmentMoney rhs = ((PresentmentMoney) other);

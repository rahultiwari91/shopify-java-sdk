...
public class SubtotalPriceSet implements Serializable {
	...
	private final static long serialVersionUID = 3874398808021834946L;
	 ...
	 * @param shopMoney
	 */
	public SubtotalPriceSet(ShopMoney shopMoney, PresentmentMoney presentmentMoney) {
		super();
	...
	public SubtotalPriceSet withShopMoney(ShopMoney shopMoney) {
		this.shopMoney = shopMoney;
		return this;
	}
	...
	public SubtotalPriceSet withPresentmentMoney(PresentmentMoney presentmentMoney) {
		this.presentmentMoney = presentmentMoney;
		return this;
	}
	...
	public SubtotalPriceSet withAdditionalProperty(String name, Object value) {
		this.additionalProperties.put(name, value);
		return this;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other instanceof SubtotalPriceSet) == false) {
			return false;
		}
		SubtotalPriceSet rhs = ((SubtotalPriceSet) other);

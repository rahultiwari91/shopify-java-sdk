...
public class DiscountedPriceSet implements Serializable {
	...
	private final static long serialVersionUID = -8989860461953819946L;
	 ...
	 * @param shopMoney
	 */
	public DiscountedPriceSet(ShopMoney shopMoney, PresentmentMoney presentmentMoney) {
		super();
	...
	public DiscountedPriceSet withShopMoney(ShopMoney shopMoney) {
		this.shopMoney = shopMoney;
		return this;
	}
	...
	public DiscountedPriceSet withPresentmentMoney(PresentmentMoney presentmentMoney) {
		this.presentmentMoney = presentmentMoney;
		return this;
	}
	...
	public DiscountedPriceSet withAdditionalProperty(String name, Object value) {
		this.additionalProperties.put(name, value);
		return this;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other instanceof DiscountedPriceSet) == false) {
			return false;
		}
		DiscountedPriceSet rhs = ((DiscountedPriceSet) other);

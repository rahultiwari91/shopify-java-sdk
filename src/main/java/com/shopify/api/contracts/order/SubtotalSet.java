...
public class SubtotalSet implements Serializable {
	...
	private final static long serialVersionUID = 3076194223690035706L;
	 ...
	 * @param shopMoney
	 */
	public SubtotalSet(ShopMoney shopMoney, PresentmentMoney presentmentMoney) {
		super();
	...
	public SubtotalSet withShopMoney(ShopMoney shopMoney) {
		this.shopMoney = shopMoney;
		return this;
	}
	...
	public SubtotalSet withPresentmentMoney(PresentmentMoney presentmentMoney) {
		this.presentmentMoney = presentmentMoney;
		return this;
	}
	...
	public SubtotalSet withAdditionalProperty(String name, Object value) {
		this.additionalProperties.put(name, value);
		return this;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other instanceof SubtotalSet) == false) {
			return false;
		}
		SubtotalSet rhs = ((SubtotalSet) other);

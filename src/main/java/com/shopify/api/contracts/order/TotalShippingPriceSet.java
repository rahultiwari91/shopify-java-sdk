...
public class TotalShippingPriceSet implements Serializable {
	...
	private final static long serialVersionUID = -1141359597138272662L;
	 ...
	 * @param shopMoney
	 */
	public TotalShippingPriceSet(ShopMoney shopMoney, PresentmentMoney presentmentMoney) {
		super();
	...
	public TotalShippingPriceSet withShopMoney(ShopMoney shopMoney) {
		this.shopMoney = shopMoney;
		return this;
	}
	...
	public TotalShippingPriceSet withPresentmentMoney(PresentmentMoney presentmentMoney) {
		this.presentmentMoney = presentmentMoney;
		return this;
	}
	...
	public TotalShippingPriceSet withAdditionalProperty(String name, Object value) {
		this.additionalProperties.put(name, value);
		return this;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other instanceof TotalShippingPriceSet) == false) {
			return false;
		}
		TotalShippingPriceSet rhs = ((TotalShippingPriceSet) other);

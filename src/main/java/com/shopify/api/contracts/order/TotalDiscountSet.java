...
public class TotalDiscountSet implements Serializable {
	...
	private final static long serialVersionUID = -5688636309625088464L;
	 ...
	 * @param shopMoney
	 */
	public TotalDiscountSet(ShopMoney shopMoney, PresentmentMoney presentmentMoney) {
		super();
	...
	public TotalDiscountSet withShopMoney(ShopMoney shopMoney) {
		this.shopMoney = shopMoney;
		return this;
	}
	...
	public TotalDiscountSet withPresentmentMoney(PresentmentMoney presentmentMoney) {
		this.presentmentMoney = presentmentMoney;
		return this;
	}
	...
	public TotalDiscountSet withAdditionalProperty(String name, Object value) {
		this.additionalProperties.put(name, value);
		return this;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other instanceof TotalDiscountSet) == false) {
			return false;
		}
		TotalDiscountSet rhs = ((TotalDiscountSet) other);

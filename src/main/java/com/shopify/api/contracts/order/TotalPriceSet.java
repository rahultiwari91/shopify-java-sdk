...
public class TotalPriceSet implements Serializable {
	...
	private final static long serialVersionUID = -4779818812712550773L;
	 ...
	 * @param shopMoney
	 */
	public TotalPriceSet(ShopMoney shopMoney, PresentmentMoney presentmentMoney) {
		super();
	...
	public TotalPriceSet withShopMoney(ShopMoney shopMoney) {
		this.shopMoney = shopMoney;
		return this;
	}
	...
	public TotalPriceSet withPresentmentMoney(PresentmentMoney presentmentMoney) {
		this.presentmentMoney = presentmentMoney;
		return this;
	}
	...
	public TotalPriceSet withAdditionalProperty(String name, Object value) {
		this.additionalProperties.put(name, value);
		return this;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other instanceof TotalPriceSet) == false) {
			return false;
		}
		TotalPriceSet rhs = ((TotalPriceSet) other);

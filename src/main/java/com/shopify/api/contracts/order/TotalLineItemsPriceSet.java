...
public class TotalLineItemsPriceSet implements Serializable {
	...
	private final static long serialVersionUID = -7145639508507704986L;
	 ...
	 * @param shopMoney
	 */
	public TotalLineItemsPriceSet(ShopMoney shopMoney, PresentmentMoney presentmentMoney) {
		super();
	...
	public TotalLineItemsPriceSet withShopMoney(ShopMoney shopMoney) {
		this.shopMoney = shopMoney;
		return this;
	}
	...
	public TotalLineItemsPriceSet withPresentmentMoney(PresentmentMoney presentmentMoney) {
		this.presentmentMoney = presentmentMoney;
		return this;
	}
	...
	public TotalLineItemsPriceSet withAdditionalProperty(String name, Object value) {
		this.additionalProperties.put(name, value);
		return this;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other instanceof TotalLineItemsPriceSet) == false) {
			return false;
		}
		TotalLineItemsPriceSet rhs = ((TotalLineItemsPriceSet) other);

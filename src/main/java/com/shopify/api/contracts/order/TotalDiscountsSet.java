...
public class TotalDiscountsSet implements Serializable {
	...
	private final static long serialVersionUID = 5556564581766146677L;
	 ...
	 * @param shopMoney
	 */
	public TotalDiscountsSet(ShopMoney shopMoney, PresentmentMoney presentmentMoney) {
		super();
	...
	public TotalDiscountsSet withShopMoney(ShopMoney shopMoney) {
		this.shopMoney = shopMoney;
		return this;
	}
	...
	public TotalDiscountsSet withPresentmentMoney(PresentmentMoney presentmentMoney) {
		this.presentmentMoney = presentmentMoney;
		return this;
	}
	...
	public TotalDiscountsSet withAdditionalProperty(String name, Object value) {
		this.additionalProperties.put(name, value);
		return this;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other instanceof TotalDiscountsSet) == false) {
			return false;
		}
		TotalDiscountsSet rhs = ((TotalDiscountsSet) other);

...
import com.shopify.api.urls.OrderUrl;
...
public class OrderResourceClient {
	 ...
	 * @throws Exception
	 */
	public static ShopifyClient<List<Order>> getOrders() throws Exception {
		return null;
	}
	 ...
	 * @throws Exception
	 */
	public static ShopifyClient<List<Order>> getOrdersByStatus(String status) throws Exception {
		return null;
	}
	 ...
	 * Filter orders.
	 * 
	 * @param startIndex - Start index to search data from.
	 ...
	 * @throws Exception
	 */
	public static ShopifyClient<List<Order>> getOrders(Integer startIndex, Integer limit, String order, String filter,
	...
	public static ShopifyClient<OrderResponse> getOrder(Long orderId) throws Exception {
		String url = OrderUrl.getOrderUrl(orderId);
		String requstMethod = "GET";
		Class<?> clz = OrderResponse.class;
		ShopifyClient<OrderResponse> shopifyClient = (ShopifyClient<OrderResponse>) ShopifyClientFactory.getInstance(clz);
	 ...
	 * @throws Exception
	 */
	public static ShopifyClient<Count> getOrderCount() throws Exception {
		return null;
	}
	 ...
	 * @throws Exception
	 */
	public static ShopifyClient<Count> getOrderCount(String filter) throws Exception {
		return null;
	}
	 ...
	 * @throws Exception
	 */
	public static ShopifyClient<Order> createOrder(Order Order) throws Exception {
		return null;
	}
	 ...
	 * @throws Exception
	 */
	public static ShopifyClient<OrderResponse> updateOrder(Order Order) throws Exception {
		String url = OrderUrl.getOrderUrl(Order.getId());
	 ...
	 * @throws Exception
	 */
	public static ShopifyClient<Order> closeOrder(String orderId) throws Exception {
		return null;
	}
	 ...
	 * @throws Exception
	 */
	public static ShopifyClient<Order> reOpenOrder(String orderId) throws Exception {
		return null;
	}
	 ...
	 * @throws Exception
	 */
	public static ShopifyClient<Order> cancelOrder(String orderId) throws Exception {
		return null;
	}

...
public class CustomerResource {
	...
	public CustomerResource(ApiContext apiContext) 
	{
	 ...
	 * @throws Exception
	 */
	Collection<Customer> getCustomers(Integer limit, String filter, String fields) throws Exception {
		return null;
	}
	 ...
	 * @throws Exception
	 */
	Collection<Customer> getCustomers(Integer limit, String order, String query, String fields) throws Exception {
		return null;
	}
	 ...
	 * @throws Exception
	 */
	Customer getCustomer(String customerId, String fields) throws Exception {
		return null;
	}
	 ...
	 * @throws Exception
	 */
	Count customersCount() throws Exception {
		return null;
	}
	 ...
	 * @throws Exception
	 */
	Collection<Order> getOrders(String customerId) throws Exception {
		return null;
	}
